...
import med.voll.api.domain.desafio.ValidadorCancelamientoDeConsulta;
...
public class AgendaDeConsultaService {
    ...
    public DatosDetalleConsulta agendar(DatosAgendarConsulta datos){
        ...
        if(medico==null){
            throw new ValidacionDeIntegredad("no existen medicos disponibles para este horario y especialidad");
        }
    ...
    public void cancelar(DatosCancelamientoConsulta datos){
        if(!consultaRepository.existsById(datos.idConsulta())){
            throw new ValidacionDeIntegredad("id de la consulta informada no exixte");
        }
